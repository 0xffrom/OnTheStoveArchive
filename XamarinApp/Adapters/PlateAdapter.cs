...
namespace XamarinApp
{
    public class PlateAdapter : RecyclerView.Adapter
    {
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            vh.Background.SetBackgroundResource(_activity.Resources.GetIdentifier(_items[position].Background, "drawable", _activity.PackageName));
        }

        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            View itemView = LayoutInflater.From(parent.Context).
                Inflate(Resource.Layout.list_plates, parent, false);
